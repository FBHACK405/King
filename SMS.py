...
interV = 10 #Script repeat interval in seconds
...
def smsforward():
    ...
    if not os.path.exists(tmpFile):
        # Saved time time not found. Setting up and saving current time as last forwar time
...
# sms sms forward function for the first time
smsforward()
