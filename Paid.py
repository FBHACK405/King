...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Abdullah Hacker\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Abdullah \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : FBHACK405 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./bhatti405\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/FBHACK405/FBHACK405/blob/main/Approval.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/bhatti405")
...
def notice():
	...
	os.system("xdg-open 03105194031?app=Whatapp")
	runtxt("\033[0;97m Key Approval ke Lai Whatapp Number 03105194032 >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key group admin ke post pe coment krein")
	os.system("xdg-open 03105194032?app=Whatapp")
	subprocess.check_output(["am", "start", "03105194032?app=Whatapp"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/FBHACK405/FBHACK405/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
{_   _}\ \/ / | {}  }| {_     { {__  /  {}  \|  `.'  || {_ {_   _}| {_} || ||  `| |/   __}    / {} \ | {}  }| {}  \| { } || |   | |    / {} \ | {_} |
  ...
  `-'   `--'  `-'    `----'   `----'  `----' `-' ` `-'`----' `-'  `-' `-'`-'`-' `-' `---'    `-'  `-'`----' `----' `-----'`----'`----'`-'  `-'`-' `-'
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Hacker\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Bhatti405 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/FBHACK405 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./Bhatti405 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
